...
BEGIN_MESSAGE_MAP(CViveRemoterApp, CWinApp)
...
CViveRemoterApp::CViveRemoterApp()
{
	// 支援重新啟動管理員
...
// 僅有的一個 CViveRemoterApp 物件

CViveRemoterApp theApp;


// CViveRemoterApp 初始設定

BOOL CViveRemoterApp::InitInstance()
{
